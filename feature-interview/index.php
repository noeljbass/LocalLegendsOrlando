...
$socialFields = ['social_facebook' => 'Facebook', 'social_instagram' => 'Instagram', 'social_tiktok' => 'TikTok', 'social_youtube' => 'YouTube', 'social_linkedin' => 'LinkedIn', 'social_x' => 'X', 'social_pinterest' => 'Pinterest', 'social_other' => 'Other'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        foreach ($socialFields as $field => $label) {
            $socialUrl = is_string($_POST[$field] ?? null) ? trim($_POST[$field]) : '';
            if ($socialUrl !== '') $socialLinks[] = $label . ': ' . $socialUrl;
        }
        $values['social_links'] = implode("\n", $socialLinks);
