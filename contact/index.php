...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        guard_post_payload();
        verify_csrf(true);
        if (!empty($_POST['topic_extra']) || !empty($_POST['company'])) throw new RuntimeException('Unable to send this message. Please refresh this page and try again.');
