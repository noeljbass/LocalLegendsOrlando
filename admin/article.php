...
$badgeArticle = ['slug' => $article['slug'] ?? '', 'public_type' => $article['public_type'] ?? 'story'];
$featuredBadgeHtml = featured_badge_embed_html($badgeArticle);
$featuredBadgeTrackedUrl = article_public_tracked_badge_url($badgeArticle);
