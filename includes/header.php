...
<header class="site-header"><a class="brand" href="<?= url() ?>" aria-label="Local Legends Orlando home"><img src="<?= url('assets/images/local-legends-long-logo.webp') ?>" alt="Local Legends Orlando"></a><button class="nav-toggle" aria-expanded="false" aria-controls="site-nav">Menu</button><nav id="site-nav" class="site-nav" aria-label="Primary"><a href="<?= url('stories/') ?>">Stories</a><a href="<?= url('search/') ?>">Search</a><a href="<?= url('categories/') ?>">Categories</a><a href="<?= url('about/') ?>">About</a><a href="<?= url('contact/') ?>">Contact</a><a class="button button-small" href="<?= url('get-featured/') ?>">Get Featured</a></nav></header>
<main id="main">
